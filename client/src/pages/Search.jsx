...
function Search() {
  ...
  const handleSubmit = (e) => {
    ...
    urlParams.sort("sort", sidebarData.sort);
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              id="searchTerm"
              placeholder="Search ..."
              className="border rounded-lgp-3 w-full"
          ...
          <button className="bg-slate-700 uppercase p-3 rounded-lg hover:opacity-95 text-white">
            Search
          </button>
        </form>
      </div>
      <div className="flex-1">
        <h1 className="text-3xl font-semibold border-b p-3 tex-slate-700">
          Listing Results
        </h1>
